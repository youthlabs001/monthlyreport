...
CREATE TABLE IF NOT EXISTS public.app_users (
    ...
    password_hash TEXT,  -- 로그인용 비밀번호 (평문 저장 - 간단한 데모용)
...
CREATE INDEX IF NOT EXISTS idx_transactions_company ON public.transactions(company_name);
...
-- transactions: 익명 사용자도 읽기 가능 (대시보드 조회), 쓰기는 인증 필요
